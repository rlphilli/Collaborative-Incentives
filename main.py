...
if  __name__ == "__main__":
    ...
    blum_results = run_blum(trained_model, names, training_samples, validation_indices, emnist_data, trials=10)
    fedavg_results = run_fedavg(trained_model, names, training_samples, validation_indices, emnist_data, trials=10)
